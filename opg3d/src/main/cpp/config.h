...
#define OPG3D_BUILD_TAG "23.1.3 ARM64 lobby gate v5 + progression + crafts + weapon/armor modules + local id + assets/data + post-match visibility + forced online + armory/rank repair v3 + high-tier bots"
#endif
